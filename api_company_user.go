...
// CompanyUserAPIService CompanyUserAPI service
type CompanyUserAPIService service

type ApiUpdateCompanyUserRequest struct {
	ctx            context.Context
	ApiService     *CompanyUserAPIService
	xRequestedWith *string
}

// Used to send the XMLHttpRequest header
func (r ApiUpdateCompanyUserRequest) XRequestedWith(xRequestedWith string) ApiUpdateCompanyUserRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

func (r ApiUpdateCompanyUserRequest) Execute() (*CompanyUser, *http.Response, error) {
	return r.ApiService.UpdateCompanyUserExecute(r)
}

/*
UpdateCompanyUser Update a company user record
...
*/
func (a *CompanyUserAPIService) UpdateCompanyUser(ctx context.Context) ApiUpdateCompanyUserRequest {
	return ApiUpdateCompanyUserRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CompanyUserAPIService) UpdateCompanyUserExecute(r ApiUpdateCompanyUserRequest) (*CompanyUser, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CompanyUserAPIService.UpdateCompanyUser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/company_users"
