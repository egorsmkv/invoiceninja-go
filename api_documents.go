...
func (r ApiGetDocumentsRequest) XAPITOKEN(xAPITOKEN string) ApiGetDocumentsRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiGetDocumentsRequest) XRequestedWith(xRequestedWith string) ApiGetDocumentsRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiGetDocumentsRequest) Include(include string) ApiGetDocumentsRequest {
	r.include = &include
	return r
}
...
func (r ApiGetDocumentsRequest) Index(index string) ApiGetDocumentsRequest {
	r.index = &index
	return r
}

func (r ApiGetDocumentsRequest) Execute() (*GetDocuments200Response, *http.Response, error) {
