...
func (r ApiActionPaymentRequest) XAPITOKEN(xAPITOKEN string) ApiActionPaymentRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiActionPaymentRequest) XRequestedWith(xRequestedWith string) ApiActionPaymentRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiActionPaymentRequest) Include(include string) ApiActionPaymentRequest {
	r.include = &include
	return r
}

func (r ApiActionPaymentRequest) Execute() (*Payment, *http.Response, error) {
	return r.ApiService.ActionPaymentExecute(r)
}

/*
ActionPayment Custom payment actions
...
func (a *PaymentsAPIService) ActionPaymentExecute(r ApiActionPaymentRequest) (*Payment, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/payments/{id}/{action}"
...
// The API token to be used for authentication
func (r ApiBulkPaymentsRequest) XAPITOKEN(xAPITOKEN string) ApiBulkPaymentsRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiBulkPaymentsRequest) XRequestedWith(xRequestedWith string) ApiBulkPaymentsRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// User credentials
func (r ApiBulkPaymentsRequest) RequestBody(requestBody []int32) ApiBulkPaymentsRequest {
...
func (r ApiBulkPaymentsRequest) Execute() (*Payment, *http.Response, error) {
	return r.ApiService.BulkPaymentsExecute(r)
}
...
func (a *PaymentsAPIService) BulkPaymentsExecute(r ApiBulkPaymentsRequest) (*Payment, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/payments/bulk"
...
// The API token to be used for authentication
func (r ApiDeletePaymentRequest) XAPITOKEN(xAPITOKEN string) ApiDeletePaymentRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiDeletePaymentRequest) XRequestedWith(xRequestedWith string) ApiDeletePaymentRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiDeletePaymentRequest) Include(include string) ApiDeletePaymentRequest {
	r.include = &include
	return r
}
...
// The API token to be used for authentication
func (r ApiEditPaymentRequest) XAPITOKEN(xAPITOKEN string) ApiEditPaymentRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiEditPaymentRequest) XRequestedWith(xRequestedWith string) ApiEditPaymentRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiEditPaymentRequest) Include(include string) ApiEditPaymentRequest {
	r.include = &include
	return r
}

func (r ApiEditPaymentRequest) Execute() (*Payment, *http.Response, error) {
	return r.ApiService.EditPaymentExecute(r)
}
...
func (a *PaymentsAPIService) EditPaymentExecute(r ApiEditPaymentRequest) (*Payment, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/payments/{id}/edit"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
// The API token to be used for authentication
func (r ApiGetPaymentsRequest) XAPITOKEN(xAPITOKEN string) ApiGetPaymentsRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiGetPaymentsRequest) XRequestedWith(xRequestedWith string) ApiGetPaymentsRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiGetPaymentsRequest) Include(include string) ApiGetPaymentsRequest {
	r.include = &include
	return r
}
...
func (r ApiGetPaymentsRequest) Sort(sort string) ApiGetPaymentsRequest {
	r.sort = &sort
	return r
}
...
// The API token to be used for authentication
func (r ApiGetPaymentsCreateRequest) XAPITOKEN(xAPITOKEN string) ApiGetPaymentsCreateRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiGetPaymentsCreateRequest) XRequestedWith(xRequestedWith string) ApiGetPaymentsCreateRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiGetPaymentsCreateRequest) Include(include string) ApiGetPaymentsCreateRequest {
	r.include = &include
	return r
}

func (r ApiGetPaymentsCreateRequest) Execute() (*Payment, *http.Response, error) {
	return r.ApiService.GetPaymentsCreateExecute(r)
}

/*
GetPaymentsCreate Blank payment
...
// The API token to be used for authentication
func (r ApiShowPaymentRequest) XAPITOKEN(xAPITOKEN string) ApiShowPaymentRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiShowPaymentRequest) XRequestedWith(xRequestedWith string) ApiShowPaymentRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiShowPaymentRequest) Include(include string) ApiShowPaymentRequest {
	r.include = &include
	return r
}

func (r ApiShowPaymentRequest) Execute() (*Payment, *http.Response, error) {
	return r.ApiService.ShowPaymentExecute(r)
}
...
// The API token to be used for authentication
func (r ApiStorePaymentRequest) XAPITOKEN(xAPITOKEN string) ApiStorePaymentRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiStorePaymentRequest) XRequestedWith(xRequestedWith string) ApiStorePaymentRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}
...
func (r ApiStorePaymentRequest) PaymentRequest(paymentRequest PaymentRequest) ApiStorePaymentRequest {
	r.paymentRequest = &paymentRequest
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiStorePaymentRequest) Include(include string) ApiStorePaymentRequest {
	r.include = &include
	return r
}
...
func (r ApiStorePaymentRequest) Execute() (*Payment, *http.Response, error) {
	return r.ApiService.StorePaymentExecute(r)
}

/*
StorePayment Create payment
...
func (a *PaymentsAPIService) StorePaymentExecute(r ApiStorePaymentRequest) (*Payment, *http.Response, error) {
	...
	if r.emailReceipt != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "email_receipt", r.emailReceipt, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{"application/json"}
...
// The API token to be used for authentication
func (r ApiStoreRefundRequest) XAPITOKEN(xAPITOKEN string) ApiStoreRefundRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiStoreRefundRequest) XRequestedWith(xRequestedWith string) ApiStoreRefundRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// The refund request
func (r ApiStoreRefundRequest) Payment(payment Payment) ApiStoreRefundRequest {
	r.payment = &payment
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiStoreRefundRequest) Include(include string) ApiStoreRefundRequest {
	r.include = &include
	return r
}

func (r ApiStoreRefundRequest) Execute() (*Payment, *http.Response, error) {
	return r.ApiService.StoreRefundExecute(r)
}

/*
StoreRefund Refund payment
...
func (a *PaymentsAPIService) StoreRefundExecute(r ApiStoreRefundRequest) (*Payment, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/payments/refund"
...
// The API token to be used for authentication
func (r ApiUpdatePaymentRequest) XAPITOKEN(xAPITOKEN string) ApiUpdatePaymentRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiUpdatePaymentRequest) XRequestedWith(xRequestedWith string) ApiUpdatePaymentRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiUpdatePaymentRequest) Include(include string) ApiUpdatePaymentRequest {
	r.include = &include
	return r
}
...
// The API token to be used for authentication
func (r ApiUploadPaymentRequest) XAPITOKEN(xAPITOKEN string) ApiUploadPaymentRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiUploadPaymentRequest) XRequestedWith(xRequestedWith string) ApiUploadPaymentRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiUploadPaymentRequest) Include(include string) ApiUploadPaymentRequest {
	r.include = &include
	return r
}

func (r ApiUploadPaymentRequest) Method(method string) ApiUploadPaymentRequest {
	r.method = &method
	return r
}

func (r ApiUploadPaymentRequest) Documents(documents []*os.File) ApiUploadPaymentRequest {
	r.documents = documents
	return r
}

func (r ApiUploadPaymentRequest) Execute() (*Payment, *http.Response, error) {
	return r.ApiService.UploadPaymentExecute(r)
}

/*
UploadPayment Upload a payment document
...
func (a *PaymentsAPIService) UploadPaymentExecute(r ApiUploadPaymentRequest) (*Payment, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/payments/{id}/upload"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
