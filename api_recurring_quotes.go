...
func (r ApiActionRecurringQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiActionRecurringQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiActionRecurringQuoteRequest) XRequestedWith(xRequestedWith string) ApiActionRecurringQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiActionRecurringQuoteRequest) Include(include string) ApiActionRecurringQuoteRequest {
	r.include = &include
	return r
}

func (r ApiActionRecurringQuoteRequest) Execute() (*RecurringQuote, *http.Response, error) {
	return r.ApiService.ActionRecurringQuoteExecute(r)
}

/*
ActionRecurringQuote Performs a custom action on an RecurringQuote
...
func (a *RecurringQuotesAPIService) ActionRecurringQuoteExecute(r ApiActionRecurringQuoteRequest) (*RecurringQuote, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/recurring_quotes/{id}/{action}"
...
// The API token to be used for authentication
func (r ApiBulkRecurringQuotesRequest) XAPITOKEN(xAPITOKEN string) ApiBulkRecurringQuotesRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiBulkRecurringQuotesRequest) XRequestedWith(xRequestedWith string) ApiBulkRecurringQuotesRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Hashed ids
func (r ApiBulkRecurringQuotesRequest) RequestBody(requestBody []int32) ApiBulkRecurringQuotesRequest {
...
func (r ApiBulkRecurringQuotesRequest) Execute() (*RecurringQuote, *http.Response, error) {
	return r.ApiService.BulkRecurringQuotesExecute(r)
}
...
func (a *RecurringQuotesAPIService) BulkRecurringQuotesExecute(r ApiBulkRecurringQuotesRequest) (*RecurringQuote, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/recurring_quotes/bulk"
...
// The API token to be used for authentication
func (r ApiDeleteRecurringQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiDeleteRecurringQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiDeleteRecurringQuoteRequest) XRequestedWith(xRequestedWith string) ApiDeleteRecurringQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiDeleteRecurringQuoteRequest) Include(include string) ApiDeleteRecurringQuoteRequest {
	r.include = &include
	return r
}

func (r ApiDeleteRecurringQuoteRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteRecurringQuoteExecute(r)
}

/*
DeleteRecurringQuote Deletes a RecurringQuote
...
func (a *RecurringQuotesAPIService) DeleteRecurringQuoteExecute(r ApiDeleteRecurringQuoteRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/recurring_quotes/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
// The API token to be used for authentication
func (r ApiEditRecurringQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiEditRecurringQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiEditRecurringQuoteRequest) XRequestedWith(xRequestedWith string) ApiEditRecurringQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiEditRecurringQuoteRequest) Include(include string) ApiEditRecurringQuoteRequest {
	r.include = &include
	return r
}

func (r ApiEditRecurringQuoteRequest) Execute() (*RecurringQuote, *http.Response, error) {
	return r.ApiService.EditRecurringQuoteExecute(r)
}

/*
EditRecurringQuote Shows an RecurringQuote for editting
...
func (a *RecurringQuotesAPIService) EditRecurringQuoteExecute(r ApiEditRecurringQuoteRequest) (*RecurringQuote, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/recurring_quotes/{id}/edit"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
// The API token to be used for authentication
func (r ApiGetRecurringQuotesRequest) XAPITOKEN(xAPITOKEN string) ApiGetRecurringQuotesRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiGetRecurringQuotesRequest) XRequestedWith(xRequestedWith string) ApiGetRecurringQuotesRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiGetRecurringQuotesRequest) Include(include string) ApiGetRecurringQuotesRequest {
	r.include = &include
	return r
}

func (r ApiGetRecurringQuotesRequest) Execute() (*GetRecurringQuotes200Response, *http.Response, error) {
	return r.ApiService.GetRecurringQuotesExecute(r)
}

/*
GetRecurringQuotes Gets a list of recurring_quotes
...
func (a *RecurringQuotesAPIService) GetRecurringQuotesExecute(r ApiGetRecurringQuotesRequest) (*GetRecurringQuotes200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/recurring_quotes"
...
// The API token to be used for authentication
func (r ApiGetRecurringQuotesCreateRequest) XAPITOKEN(xAPITOKEN string) ApiGetRecurringQuotesCreateRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiGetRecurringQuotesCreateRequest) XRequestedWith(xRequestedWith string) ApiGetRecurringQuotesCreateRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiGetRecurringQuotesCreateRequest) Include(include string) ApiGetRecurringQuotesCreateRequest {
	r.include = &include
	return r
}

func (r ApiGetRecurringQuotesCreateRequest) Execute() (*RecurringQuote, *http.Response, error) {
	return r.ApiService.GetRecurringQuotesCreateExecute(r)
}

/*
GetRecurringQuotesCreate Gets a new blank RecurringQuote object
...
func (a *RecurringQuotesAPIService) GetRecurringQuotesCreateExecute(r ApiGetRecurringQuotesCreateRequest) (*RecurringQuote, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/recurring_quotes/create"
...
// The API token to be used for authentication
func (r ApiShowRecurringQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiShowRecurringQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiShowRecurringQuoteRequest) XRequestedWith(xRequestedWith string) ApiShowRecurringQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiShowRecurringQuoteRequest) Include(include string) ApiShowRecurringQuoteRequest {
	r.include = &include
	return r
}

func (r ApiShowRecurringQuoteRequest) Execute() (*RecurringQuote, *http.Response, error) {
	return r.ApiService.ShowRecurringQuoteExecute(r)
}

/*
ShowRecurringQuote Shows an RecurringQuote
...
// The API token to be used for authentication
func (r ApiStoreRecurringQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiStoreRecurringQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiStoreRecurringQuoteRequest) XRequestedWith(xRequestedWith string) ApiStoreRecurringQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiStoreRecurringQuoteRequest) Include(include string) ApiStoreRecurringQuoteRequest {
	r.include = &include
	return r
}

func (r ApiStoreRecurringQuoteRequest) Execute() (*RecurringQuote, *http.Response, error) {
	return r.ApiService.StoreRecurringQuoteExecute(r)
}

/*
StoreRecurringQuote Adds a RecurringQuote
...
// The API token to be used for authentication
func (r ApiUpdateRecurringQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiUpdateRecurringQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiUpdateRecurringQuoteRequest) XRequestedWith(xRequestedWith string) ApiUpdateRecurringQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiUpdateRecurringQuoteRequest) Include(include string) ApiUpdateRecurringQuoteRequest {
	r.include = &include
	return r
}

func (r ApiUpdateRecurringQuoteRequest) Execute() (*RecurringQuote, *http.Response, error) {
	return r.ApiService.UpdateRecurringQuoteExecute(r)
}

/*
UpdateRecurringQuote Updates an RecurringQuote
