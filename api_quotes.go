...
type ApiActionQuoteRequest struct {
	ctx context.Context
...
func (r ApiActionQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiActionQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiActionQuoteRequest) XRequestedWith(xRequestedWith string) ApiActionQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiActionQuoteRequest) Include(include string) ApiActionQuoteRequest {
	r.include = &include
	return r
}

func (r ApiActionQuoteRequest) Execute() (*Quote, *http.Response, error) {
	return r.ApiService.ActionQuoteExecute(r)
}

/*
ActionQuote Performs a custom action on an Quote
...
Performs a custom action on an Quote.
 ...
 @return ApiActionQuoteRequest

Deprecated
*/
func (a *QuotesAPIService) ActionQuote(ctx context.Context, id string, action string) ApiActionQuoteRequest {
	return ApiActionQuoteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *QuotesAPIService) ActionQuoteExecute(r ApiActionQuoteRequest) (*Quote, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotesAPIService.ActionQuote")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/quotes/{id}/{action}"
...
type ApiBulkQuotesRequest struct {
	ctx context.Context
	ApiService *QuotesAPIService
	xAPITOKEN *string
	xRequestedWith *string
	bulkQuotesRequest *BulkQuotesRequest
	index *string
}

// The API token to be used for authentication
func (r ApiBulkQuotesRequest) XAPITOKEN(xAPITOKEN string) ApiBulkQuotesRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiBulkQuotesRequest) XRequestedWith(xRequestedWith string) ApiBulkQuotesRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Bulk action details
func (r ApiBulkQuotesRequest) BulkQuotesRequest(bulkQuotesRequest BulkQuotesRequest) ApiBulkQuotesRequest {
	r.bulkQuotesRequest = &bulkQuotesRequest
	return r
}
...
func (r ApiBulkQuotesRequest) Index(index string) ApiBulkQuotesRequest {
	r.index = &index
	return r
}

func (r ApiBulkQuotesRequest) Execute() (*Quote, *http.Response, error) {
	return r.ApiService.BulkQuotesExecute(r)
}

/*
BulkQuotes Bulk quote actions
...
Performs bulk actions on an array of quotes
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiBulkQuotesRequest
*/
func (a *QuotesAPIService) BulkQuotes(ctx context.Context) ApiBulkQuotesRequest {
	return ApiBulkQuotesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *QuotesAPIService) BulkQuotesExecute(r ApiBulkQuotesRequest) (*Quote, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotesAPIService.BulkQuotes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/quotes/bulk"
	...
	if r.bulkQuotesRequest == nil {
		return localVarReturnValue, nil, reportError("bulkQuotesRequest is required and must be specified")
	}
	...
	parameterAddToHeaderOrQuery(localVarHeaderParams, "X-Requested-With", r.xRequestedWith, "simple", "")
	// body params
	localVarPostBody = r.bulkQuotesRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
// The API token to be used for authentication
func (r ApiDeleteQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiDeleteQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiDeleteQuoteRequest) XRequestedWith(xRequestedWith string) ApiDeleteQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiDeleteQuoteRequest) Include(include string) ApiDeleteQuoteRequest {
	r.include = &include
	return r
}
...
*/
func (a *QuotesAPIService) DeleteQuote(ctx context.Context, id string) ApiDeleteQuoteRequest {
	return ApiDeleteQuoteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *QuotesAPIService) DeleteQuoteExecute(r ApiDeleteQuoteRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/quotes/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiDownloadCreditRequest struct {
	ctx context.Context
	ApiService *QuotesAPIService
	xAPITOKEN *string
	xRequestedWith *string
...
// The API token to be used for authentication
func (r ApiDownloadCreditRequest) XAPITOKEN(xAPITOKEN string) ApiDownloadCreditRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiDownloadCreditRequest) XRequestedWith(xRequestedWith string) ApiDownloadCreditRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiDownloadCreditRequest) Include(include string) ApiDownloadCreditRequest {
	r.include = &include
	return r
}

func (r ApiDownloadCreditRequest) Execute() (*http.Response, error) {
	return r.ApiService.DownloadCreditExecute(r)
}

/*
DownloadCredit Download quote PDF

Downloads a specific quote

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param invitationKey The Credit Invitation Key
 @return ApiDownloadCreditRequest
*/
func (a *QuotesAPIService) DownloadCredit(ctx context.Context, invitationKey string) ApiDownloadCreditRequest {
	return ApiDownloadCreditRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *QuotesAPIService) DownloadCreditExecute(r ApiDownloadCreditRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotesAPIService.DownloadCredit")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/credit/{invitation_key}/download"
...
type ApiDownloadQuoteRequest struct {
	ctx context.Context
	ApiService *QuotesAPIService
	xAPITOKEN *string
	xRequestedWith *string
...
// The API token to be used for authentication
func (r ApiDownloadQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiDownloadQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiDownloadQuoteRequest) XRequestedWith(xRequestedWith string) ApiDownloadQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiDownloadQuoteRequest) Include(include string) ApiDownloadQuoteRequest {
	r.include = &include
	return r
}

func (r ApiDownloadQuoteRequest) Execute() (*http.Response, error) {
	return r.ApiService.DownloadQuoteExecute(r)
}
...
Downloads a specific quote
 ...
 @return ApiDownloadQuoteRequest
*/
func (a *QuotesAPIService) DownloadQuote(ctx context.Context, invitationKey string) ApiDownloadQuoteRequest {
	return ApiDownloadQuoteRequest{
		ApiService: a,
		ctx: ctx,
		invitationKey: invitationKey,
...
func (a *QuotesAPIService) DownloadQuoteExecute(r ApiDownloadQuoteRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotesAPIService.DownloadQuote")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/quote/{invitation_key}/download"
	localVarPath = strings.Replace(localVarPath, "{"+"invitation_key"+"}", url.PathEscape(parameterValueToString(r.invitationKey, "invitationKey")), -1)
...
type ApiEditQuoteRequest struct {
	ctx context.Context
	ApiService *QuotesAPIService
	xAPITOKEN *string
	xRequestedWith *string
...
// The API token to be used for authentication
func (r ApiEditQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiEditQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiEditQuoteRequest) XRequestedWith(xRequestedWith string) ApiEditQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiEditQuoteRequest) Include(include string) ApiEditQuoteRequest {
	r.include = &include
	return r
}

func (r ApiEditQuoteRequest) Execute() (*Quote, *http.Response, error) {
	return r.ApiService.EditQuoteExecute(r)
}
...
Displays an Quote by id for editting
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id The Quote Hashed ID
 @return ApiEditQuoteRequest
*/
func (a *QuotesAPIService) EditQuote(ctx context.Context, id string) ApiEditQuoteRequest {
	return ApiEditQuoteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *QuotesAPIService) EditQuoteExecute(r ApiEditQuoteRequest) (*Quote, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotesAPIService.EditQuote")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/quotes/{id}/edit"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
// Used to send the XMLHttpRequest header
func (r ApiGetQuotesRequest) XRequestedWith(xRequestedWith string) ApiGetQuotesRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiGetQuotesRequest) Include(include string) ApiGetQuotesRequest {
	r.include = &include
	return r
}
...
func (r ApiGetQuotesRequest) ClientId(clientId string) ApiGetQuotesRequest {
	r.clientId = &clientId
	return r
}
...
func (r ApiGetQuotesRequest) CreatedAt(createdAt int32) ApiGetQuotesRequest {
...
func (r ApiGetQuotesRequest) UpdatedAt(updatedAt int32) ApiGetQuotesRequest {
...
func (r ApiGetQuotesRequest) IsDeleted(isDeleted bool) ApiGetQuotesRequest {
...
func (r ApiGetQuotesRequest) FilterDeletedClients(filterDeletedClients string) ApiGetQuotesRequest {
...
func (r ApiGetQuotesRequest) VendorId(vendorId string) ApiGetQuotesRequest {
	r.vendorId = &vendorId
	return r
}

// Searches across a range of columns including:   - number   - custom_value1   - custom_value2   - custom_value3   - custom_value4 
func (r ApiGetQuotesRequest) Filter(filter string) ApiGetQuotesRequest {
	r.filter = &filter
	return r
}

// A comma separated list of quote status strings. Valid options include:   - all - draft   - sent   - approved - expired - upcoming    
func (r ApiGetQuotesRequest) ClientStatus(clientStatus string) ApiGetQuotesRequest {
	r.clientStatus = &clientStatus
	return r
}

// Search quote by quote number  
func (r ApiGetQuotesRequest) Number(number string) ApiGetQuotesRequest {
	r.number = &number
	return r
}

// Returns the list sorted by column in ascending or descending order.
func (r ApiGetQuotesRequest) Sort(sort string) ApiGetQuotesRequest {
	r.sort = &sort
	return r
}

func (r ApiGetQuotesRequest) Execute() (*GetQuotes200Response, *http.Response, error) {
	return r.ApiService.GetQuotesExecute(r)
}

/*
GetQuotes List quotes
...
func (a *QuotesAPIService) GetQuotesExecute(r ApiGetQuotesRequest) (*GetQuotes200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/quotes"
...
type ApiGetQuotesCreateRequest struct {
	ctx context.Context
	ApiService *QuotesAPIService
	xAPITOKEN *string
	xRequestedWith *string
...
// The API token to be used for authentication
func (r ApiGetQuotesCreateRequest) XAPITOKEN(xAPITOKEN string) ApiGetQuotesCreateRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiGetQuotesCreateRequest) XRequestedWith(xRequestedWith string) ApiGetQuotesCreateRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiGetQuotesCreateRequest) Include(include string) ApiGetQuotesCreateRequest {
	r.include = &include
	return r
}

func (r ApiGetQuotesCreateRequest) Execute() (*Quote, *http.Response, error) {
	return r.ApiService.GetQuotesCreateExecute(r)
}

/*
GetQuotesCreate Blank quote
...
Returns a blank object with default values
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetQuotesCreateRequest
*/
func (a *QuotesAPIService) GetQuotesCreate(ctx context.Context) ApiGetQuotesCreateRequest {
	return ApiGetQuotesCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *QuotesAPIService) GetQuotesCreateExecute(r ApiGetQuotesCreateRequest) (*Quote, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotesAPIService.GetQuotesCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/quotes/create"
...
type ApiShowQuoteRequest struct {
	ctx context.Context
	ApiService *QuotesAPIService
	xAPITOKEN *string
	xRequestedWith *string
...
// The API token to be used for authentication
func (r ApiShowQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiShowQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiShowQuoteRequest) XRequestedWith(xRequestedWith string) ApiShowQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiShowQuoteRequest) Include(include string) ApiShowQuoteRequest {
	r.include = &include
	return r
}

func (r ApiShowQuoteRequest) Execute() (*Quote, *http.Response, error) {
	return r.ApiService.ShowQuoteExecute(r)
}
...
Displays an Quote by id
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id The Quote Hashed ID
 @return ApiShowQuoteRequest
*/
func (a *QuotesAPIService) ShowQuote(ctx context.Context, id string) ApiShowQuoteRequest {
	return ApiShowQuoteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *QuotesAPIService) ShowQuoteExecute(r ApiShowQuoteRequest) (*Quote, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotesAPIService.ShowQuote")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiStoreQuoteRequest struct {
	ctx context.Context
	ApiService *QuotesAPIService
	xAPITOKEN *string
	xRequestedWith *string
...
// The API token to be used for authentication
func (r ApiStoreQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiStoreQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiStoreQuoteRequest) XRequestedWith(xRequestedWith string) ApiStoreQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiStoreQuoteRequest) Include(include string) ApiStoreQuoteRequest {
	r.include = &include
	return r
}

func (r ApiStoreQuoteRequest) Execute() (*Quote, *http.Response, error) {
	return r.ApiService.StoreQuoteExecute(r)
}

/*
StoreQuote Create quote
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiStoreQuoteRequest
*/
func (a *QuotesAPIService) StoreQuote(ctx context.Context) ApiStoreQuoteRequest {
	return ApiStoreQuoteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *QuotesAPIService) StoreQuoteExecute(r ApiStoreQuoteRequest) (*Quote, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotesAPIService.StoreQuote")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// The API token to be used for authentication
func (r ApiUpdateQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiUpdateQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiUpdateQuoteRequest) XRequestedWith(xRequestedWith string) ApiUpdateQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiUpdateQuoteRequest) Include(include string) ApiUpdateQuoteRequest {
	r.include = &include
	return r
}

func (r ApiUpdateQuoteRequest) Execute() (*Quote, *http.Response, error) {
...
*/
func (a *QuotesAPIService) UpdateQuote(ctx context.Context, id string) ApiUpdateQuoteRequest {
	return ApiUpdateQuoteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
type ApiUploadQuoteRequest struct {
	ctx context.Context
	ApiService *QuotesAPIService
	xAPITOKEN *string
	xRequestedWith *string
...
// The API token to be used for authentication
func (r ApiUploadQuoteRequest) XAPITOKEN(xAPITOKEN string) ApiUploadQuoteRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiUploadQuoteRequest) XRequestedWith(xRequestedWith string) ApiUploadQuoteRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiUploadQuoteRequest) Include(include string) ApiUploadQuoteRequest {
	r.include = &include
	return r
}

func (r ApiUploadQuoteRequest) Method(method string) ApiUploadQuoteRequest {
	r.method = &method
	return r
}

func (r ApiUploadQuoteRequest) Documents(documents []*os.File) ApiUploadQuoteRequest {
	r.documents = documents
	return r
}

func (r ApiUploadQuoteRequest) Execute() (*Quote, *http.Response, error) {
	return r.ApiService.UploadQuoteExecute(r)
}

/*
UploadQuote Upload a quote document

Handles the uploading of a document to a quote

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id The Quote Hashed ID
 @return ApiUploadQuoteRequest
*/
func (a *QuotesAPIService) UploadQuote(ctx context.Context, id string) ApiUploadQuoteRequest {
	return ApiUploadQuoteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *QuotesAPIService) UploadQuoteExecute(r ApiUploadQuoteRequest) (*Quote, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotesAPIService.UploadQuote")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/quotes/{id}/upload"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
