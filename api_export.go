...
func (r ApiGetExportRequest) XRequestedWith(xRequestedWith string) ApiGetExportRequest {
...
/*
GetExport Export data from the system
...
*/
func (a *ExportAPIService) GetExport(ctx context.Context) ApiGetExportRequest {
	return ApiGetExportRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ExportAPIService) GetExportExecute(r ApiGetExportRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExportAPIService.GetExport")
	if err != nil {
