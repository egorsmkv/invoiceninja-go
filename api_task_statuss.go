...
// TaskStatussAPIService TaskStatussAPI service
type TaskStatussAPIService service

type ApiDeleteTaskStatusRequest struct {
	ctx context.Context
...
func (r ApiDeleteTaskStatusRequest) XAPITOKEN(xAPITOKEN string) ApiDeleteTaskStatusRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiDeleteTaskStatusRequest) XRequestedWith(xRequestedWith string) ApiDeleteTaskStatusRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiDeleteTaskStatusRequest) Include(include string) ApiDeleteTaskStatusRequest {
	r.include = &include
	return r
}

func (r ApiDeleteTaskStatusRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteTaskStatusExecute(r)
}

/*
DeleteTaskStatus Deletes a TaskStatus Term

Handles the deletion of an TaskStatus by id

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id The TaskStatusHashed ID
 @return ApiDeleteTaskStatusRequest
*/
func (a *TaskStatussAPIService) DeleteTaskStatus(ctx context.Context, id string) ApiDeleteTaskStatusRequest {
	return ApiDeleteTaskStatusRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *TaskStatussAPIService) DeleteTaskStatusExecute(r ApiDeleteTaskStatusRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TaskStatussAPIService.DeleteTaskStatus")
	if err != nil {
