...
// ExpenseAPIService ExpenseAPI service
type ExpenseAPIService service

type ApiUploadExpenseRequest struct {
	ctx context.Context
...
func (r ApiUploadExpenseRequest) XAPITOKEN(xAPITOKEN string) ApiUploadExpenseRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiUploadExpenseRequest) XRequestedWith(xRequestedWith string) ApiUploadExpenseRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiUploadExpenseRequest) Include(include string) ApiUploadExpenseRequest {
	r.include = &include
	return r
}

func (r ApiUploadExpenseRequest) Method(method string) ApiUploadExpenseRequest {
	r.method = &method
	return r
}

func (r ApiUploadExpenseRequest) Documents(documents []*os.File) ApiUploadExpenseRequest {
	r.documents = documents
	return r
}

func (r ApiUploadExpenseRequest) Execute() (*Expense, *http.Response, error) {
	return r.ApiService.UploadExpenseExecute(r)
}

/*
UploadExpense Uploads a document to a expense

Handles the uploading of a document to a expense

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id The Expense Hashed ID
 @return ApiUploadExpenseRequest
*/
func (a *ExpenseAPIService) UploadExpense(ctx context.Context, id string) ApiUploadExpenseRequest {
	return ApiUploadExpenseRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *ExpenseAPIService) UploadExpenseExecute(r ApiUploadExpenseRequest) (*Expense, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExpenseAPIService.UploadExpense")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/expenses/{id}/upload"
