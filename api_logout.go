...
func (r ApiGetLogoutRequest) XAPITOKEN(xAPITOKEN string) ApiGetLogoutRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiGetLogoutRequest) XRequestedWith(xRequestedWith string) ApiGetLogoutRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiGetLogoutRequest) Include(include string) ApiGetLogoutRequest {
	r.include = &include
	return r
}
...
func (r ApiGetLogoutRequest) Index(index string) ApiGetLogoutRequest {
	r.index = &index
	return r
}
...
/*
GetLogout Logs the user out of their current session
...
*/
func (a *LogoutAPIService) GetLogout(ctx context.Context) ApiGetLogoutRequest {
	return ApiGetLogoutRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *LogoutAPIService) GetLogoutExecute(r ApiGetLogoutRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LogoutAPIService.GetLogout")
	if err != nil {
