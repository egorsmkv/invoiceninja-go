...
func (o *CompanyUser) GetSettings() map[string]any {
...
// and a boolean to check if the value has been set.
func (o *CompanyUser) GetSettingsOk() (map[string]any, bool) {
	if o == nil || IsNil(o.Settings) {
...
func (o *CompanyUser) GetReactSettings() map[string]any {
...
// and a boolean to check if the value has been set.
func (o *CompanyUser) GetReactSettingsOk() (map[string]any, bool) {
	if o == nil || IsNil(o.ReactSettings) {
		return map[string]any{}, false
	}
...
func (o CompanyUser) ToMap() (map[string]any, error) {
