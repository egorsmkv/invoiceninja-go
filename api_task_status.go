...
func (r ApiBulkTaskStatussRequest) XAPITOKEN(xAPITOKEN string) ApiBulkTaskStatussRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiBulkTaskStatussRequest) XRequestedWith(xRequestedWith string) ApiBulkTaskStatussRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// TaskStatus Ter,s
func (r ApiBulkTaskStatussRequest) RequestBody(requestBody []int32) ApiBulkTaskStatussRequest {
...
func (r ApiBulkTaskStatussRequest) Execute() (*TaskStatus, *http.Response, error) {
	return r.ApiService.BulkTaskStatussExecute(r)
}
...
func (a *TaskStatusAPIService) BulkTaskStatussExecute(r ApiBulkTaskStatussRequest) (*TaskStatus, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/task_statuses/bulk"
...
// The API token to be used for authentication
func (r ApiEditTaskStatussRequest) XAPITOKEN(xAPITOKEN string) ApiEditTaskStatussRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiEditTaskStatussRequest) XRequestedWith(xRequestedWith string) ApiEditTaskStatussRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiEditTaskStatussRequest) Include(include string) ApiEditTaskStatussRequest {
	r.include = &include
	return r
}

func (r ApiEditTaskStatussRequest) Execute() (*TaskStatus, *http.Response, error) {
	return r.ApiService.EditTaskStatussExecute(r)
}

/*
EditTaskStatuss Shows an TaskStatusfor editting
...
func (a *TaskStatusAPIService) EditTaskStatussExecute(r ApiEditTaskStatussRequest) (*TaskStatus, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/task_statuses/{id}/edit"
...
// The API token to be used for authentication
func (r ApiGetTaskStatusesRequest) XAPITOKEN(xAPITOKEN string) ApiGetTaskStatusesRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiGetTaskStatusesRequest) XRequestedWith(xRequestedWith string) ApiGetTaskStatusesRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiGetTaskStatusesRequest) Include(include string) ApiGetTaskStatusesRequest {
	r.include = &include
	return r
}
...
func (r ApiGetTaskStatusesRequest) Execute() (*GetTaskStatuses200Response, *http.Response, error) {
	return r.ApiService.GetTaskStatusesExecute(r)
}

/*
GetTaskStatuses Gets a list of task statuses
...
func (a *TaskStatusAPIService) GetTaskStatusesExecute(r ApiGetTaskStatusesRequest) (*GetTaskStatuses200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/task_statuses"
...
// The API token to be used for authentication
func (r ApiGetTaskStatussCreateRequest) XAPITOKEN(xAPITOKEN string) ApiGetTaskStatussCreateRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiGetTaskStatussCreateRequest) XRequestedWith(xRequestedWith string) ApiGetTaskStatussCreateRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiGetTaskStatussCreateRequest) Include(include string) ApiGetTaskStatussCreateRequest {
	r.include = &include
	return r
}

func (r ApiGetTaskStatussCreateRequest) Execute() (*TaskStatus, *http.Response, error) {
	return r.ApiService.GetTaskStatussCreateExecute(r)
}

/*
GetTaskStatussCreate Gets a new blank TaskStatus object
...
func (a *TaskStatusAPIService) GetTaskStatussCreateExecute(r ApiGetTaskStatussCreateRequest) (*TaskStatus, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/task_statuses/create"
...
// The API token to be used for authentication
func (r ApiShowTaskStatusRequest) XAPITOKEN(xAPITOKEN string) ApiShowTaskStatusRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiShowTaskStatusRequest) XRequestedWith(xRequestedWith string) ApiShowTaskStatusRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiShowTaskStatusRequest) Include(include string) ApiShowTaskStatusRequest {
	r.include = &include
	return r
}

func (r ApiShowTaskStatusRequest) Execute() (*TaskStatus, *http.Response, error) {
	return r.ApiService.ShowTaskStatusExecute(r)
}

/*
ShowTaskStatus Shows a TaskStatus Term
...
func (a *TaskStatusAPIService) ShowTaskStatusExecute(r ApiShowTaskStatusRequest) (*TaskStatus, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/task_statuses/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
// The API token to be used for authentication
func (r ApiStoreTaskStatusRequest) XAPITOKEN(xAPITOKEN string) ApiStoreTaskStatusRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiStoreTaskStatusRequest) XRequestedWith(xRequestedWith string) ApiStoreTaskStatusRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// The task_status request
func (r ApiStoreTaskStatusRequest) TaskStatus(taskStatus TaskStatus) ApiStoreTaskStatusRequest {
	r.taskStatus = &taskStatus
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiStoreTaskStatusRequest) Include(include string) ApiStoreTaskStatusRequest {
	r.include = &include
	return r
}

func (r ApiStoreTaskStatusRequest) Execute() (*TaskStatus, *http.Response, error) {
	return r.ApiService.StoreTaskStatusExecute(r)
}

/*
StoreTaskStatus Adds a TaskStatus
...
func (a *TaskStatusAPIService) StoreTaskStatusExecute(r ApiStoreTaskStatusRequest) (*TaskStatus, *http.Response, error) {
	...
	if r.taskStatus == nil {
		return localVarReturnValue, nil, reportError("taskStatus is required and must be specified")
	}
...
// The API token to be used for authentication
func (r ApiUpdateTaskStatusRequest) XAPITOKEN(xAPITOKEN string) ApiUpdateTaskStatusRequest {
	r.xAPITOKEN = &xAPITOKEN
	return r
}

// Used to send the XMLHttpRequest header
func (r ApiUpdateTaskStatusRequest) XRequestedWith(xRequestedWith string) ApiUpdateTaskStatusRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

// Includes child relationships in the response, format is comma separated. Check each model for the list of associated includes
func (r ApiUpdateTaskStatusRequest) Include(include string) ApiUpdateTaskStatusRequest {
	r.include = &include
	return r
}
...
/*
UpdateTaskStatus Updates a TaskStatus Term
