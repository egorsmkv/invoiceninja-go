...
type ApiGetPreviewRequest struct {
	ctx context.Context
...
func (r ApiGetPreviewRequest) XRequestedWith(xRequestedWith string) ApiGetPreviewRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

func (r ApiGetPreviewRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetPreviewExecute(r)
}

/*
GetPreview Returns a pdf preview

Returns a pdf preview.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetPreviewRequest
*/
func (a *PreviewAPIService) GetPreview(ctx context.Context) ApiGetPreviewRequest {
	return ApiGetPreviewRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PreviewAPIService) GetPreviewExecute(r ApiGetPreviewRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PreviewAPIService.GetPreview")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/preview"
...
type ApiGetPreviewPurchaseOrderRequest struct {
	ctx context.Context
	ApiService *PreviewAPIService
	xRequestedWith *string
}
...
// Used to send the XMLHttpRequest header
func (r ApiGetPreviewPurchaseOrderRequest) XRequestedWith(xRequestedWith string) ApiGetPreviewPurchaseOrderRequest {
	r.xRequestedWith = &xRequestedWith
	return r
}

func (r ApiGetPreviewPurchaseOrderRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetPreviewPurchaseOrderExecute(r)
}

/*
GetPreviewPurchaseOrder Returns a pdf preview for purchase order

Returns a pdf preview for purchase order.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetPreviewPurchaseOrderRequest
*/
func (a *PreviewAPIService) GetPreviewPurchaseOrder(ctx context.Context) ApiGetPreviewPurchaseOrderRequest {
	return ApiGetPreviewPurchaseOrderRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PreviewAPIService) GetPreviewPurchaseOrderExecute(r ApiGetPreviewPurchaseOrderRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PreviewAPIService.GetPreviewPurchaseOrder")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/preview/purchase_order"
