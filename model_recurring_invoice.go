...
// checks if the RecurringInvoice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecurringInvoice{}

// RecurringInvoice struct for RecurringInvoice
...
func (o RecurringInvoice) MarshalJSON() ([]byte, error) {
...
type NullableRecurringInvoice struct {
	value *RecurringInvoice
	isSet bool
}

func (v NullableRecurringInvoice) Get() *RecurringInvoice {
	return v.value
}

func (v *NullableRecurringInvoice) Set(val *RecurringInvoice) {
	v.value = val
	v.isSet = true
}

func (v NullableRecurringInvoice) IsSet() bool {
	return v.isSet
}

func (v *NullableRecurringInvoice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecurringInvoice(val *RecurringInvoice) *NullableRecurringInvoice {
	return &NullableRecurringInvoice{value: val, isSet: true}
}

func (v NullableRecurringInvoice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecurringInvoice) UnmarshalJSON(src []byte) error {
	v.isSet = true
