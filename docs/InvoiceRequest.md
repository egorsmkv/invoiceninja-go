...
**ClientId** | **string** | The client hashed id | 
...
**Invitations** | Pointer to [**[]InvoiceInvitationRequest**](InvoiceInvitationRequest.md) | An array of objects which define the invitations of the invoice | [optional] 
